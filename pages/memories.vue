<template>
  <div class="container">
    ...
    <div class="section details">
	  ...
	  <p style="text-align:right;" class="highlight">
	  I remember visiting the art museum in Chicago and Ken telling about <i>trompe l'oeil</i>.  I sort of recalled it through taking art class with him in high school, but I felt pretty lucky to be touring an art museum with <b>two</b> teachers of art!<br><br>
	  <em>Mitch Maifeld</em>
	  </p>
      <!-- CONTENT END -->
    </div>

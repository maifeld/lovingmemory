<template>
        ...
        <li><NuxtLink to="/celebration"><span class="icon">
		...
		</span><span class="menu"><span>Celebration </span>of Life</span></NuxtLink></li>
